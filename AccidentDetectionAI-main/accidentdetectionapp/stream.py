    ...
    responseData = sms.send_message(
        {
            "from": "Jatin Goyal",
            "to": "918168991401",
            "text": "Urgent \n Accident happened at muthu. Please send ambulance as soon as possible. Google map link :- https://www.google.com/maps/search/?api=1&query=47.5%2C-122.3316393 ",
        }
    )
...
def sendmail():
    ...
    gmail_list.append("arunkram10@gmail.com")
    print("gmail list",gmail_list)
    email_subject = "Urgent please send ambulance."
    email_body = "Accident happened at raj  please send ambulance as soon as possible. Google map link :- https://www.google.com/maps/search/?api=1&query=47.5%2C122.3316393 "
...
class streaming(object):
    def __init__(self):
        ...
        self.model1=torch.hub.load('ultralytics/yolov5', 'custom', path='E:/new project/AccidentDetectionAI-main/best (2).pt',device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='E:/new project/AccidentDetectionAI-main/accident2.pt',device='cpu')
